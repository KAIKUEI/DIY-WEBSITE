<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminlogin.aspx.cs" Inherits="index.adminlogin" %>
...
href="#"></A>  
            <asp:Button ID="btnSubmit" runat="server" Text="登 录"  Height="40px" Width="80px" style="color: #FFFFFF; background-color: #50a0dd" />   
           </SPAN>         </P></DIV></DIV>
		   <div style="text-align:center;">
<p>来源:<a href="index1.aspx" target="_blank">QHD-DIY</a></p>
    </div>
    </form>
</body>
</html>
