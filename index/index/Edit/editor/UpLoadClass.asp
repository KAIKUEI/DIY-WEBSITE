...
Class UpLoadClass
	...
	Private Sub Class_Initialize
		...
		m_TotalSize= 0
		m_MaxSize  = 0
		m_FileType = "jpg/gif/bmp/png/rar/zip/txt/doc/xls/ppt"
		...
		m_SavePath1 = year(date())&"/"
		m_SavePath2 = month(date())&"/"
		m_SavePath3 = day(date())&"/"
		...
		Set fout = fso.CreateTextFile(server.mappath(m_SavePath0&"index.html"))
		...
		Set fout = fso.CreateTextFile(server.mappath(m_SavePath0&m_SavePath1&"index.html"))
		fout.WriteLine "<meta http-equiv=Refresh content='1; URL=/'>您访问的页面不存在!"
		end if
		set fout=nothing
		set fso=nothing
		...
		Set fout = fso.CreateTextFile(server.mappath(m_SavePath0&m_SavePath1&m_SavePath2&"index.html"))
		fout.WriteLine "<meta http-equiv=Refresh content='1; URL=/'>您访问的页面不存在!"
		end if
		set fout=nothing
		set fso=nothing
		'日目录
		Set fso = createObject("Scripting.FileSystemObject")
		if not fso.folderexists(Server.MapPath(m_SavePath0&m_SavePath1&m_SavePath2&m_SavePath3)) then
		fso.createFolder (Server.MapPath(m_SavePath0&m_SavePath1&m_SavePath2&m_SavePath3))
		Set fout = fso.CreateTextFile(server.mappath(m_SavePath0&m_SavePath1&m_SavePath2&m_SavePath3&"index.html"))
		fout.WriteLine "<meta http-equiv=Refresh content='1; URL=/'>您访问的页面不存在!"
		end if
		set fout=nothing
		set fso=nothing
		'生成目录结束
		m_SavePath = m_SavePath0&m_SavePath1&m_SavePath2&m_SavePath3  ' 路径地址
